...
**Report naming convention:** `.memory-bank/specs/reports/{task-name}-step-{N}-{YYYY-MM-DD}.md`
...
**Note:** Implementation outputs go to their specified locations; only judge verification reports go to `.memory-bank/specs/reports/`
...
### Judge Reports
- .memory-bank/specs/reports/{task-name}-step-{N}-attempt-1.md
- .memory-bank/specs/reports/{task-name}-step-{N}-attempt-2.md
- .memory-bank/specs/reports/{task-name}-step-{N}-attempt-3.md
- .memory-bank/specs/reports/{task-name}-step-{N}-attempt-4.md
